...
svScores = cms.InputTag("dummyValueMap", "SVscore"),
  ...
  clusterizer = cms.PSet(
   clusterMaxDistance = cms.double(0.5),   #default 0.05
    clusterMaxSignificance = cms.double(12.0), #default 4.5
    clusterMinAngleCosine = cms.double(0.0), #default 0.5
